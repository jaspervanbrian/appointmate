...
export default class extends Controller {
  ...
  static targets = ["element", "submit", "form", "name", "email", "message"]
  ...
  async initialize() {
    ...
    this.submitText = this.submitTarget.value
  }
  ...
  setLoading(isLoading) {
    if (isLoading) {
      ...
      this.submitTarget.value = this.submitText ? this.submitText : "Schedule booking"
    }
  }
